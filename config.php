...
// نام بخش پلاس (برای منوی پلاس و تبدیل نقره به سکه)
// این مقدار در منوی اصلی، پیام‌های راهنما و بخش تبدیل نقره استفاده می‌شود
$brand_plus = env('BRAND_PLUS', 'پژواک پلاس');
