...
if($chat_type=='private'){
 ...
 $pejvak_club = json_encode([
    ...
    'input_field_placeholder' => "$brand_plus ⭐"
]);
...
🆔 @'.$channel['username'],
    ...
    $prizes_text = "🎁 *جوایز گردونه شانس $brand_name:*\n\n" .
                   ...
                   "5️⃣ *نقره:* بین 50 تا 100 نقره برای تبدیل به سکه در $brand_plus.\n\n" .
        ...
        switch ($result) {
            ...
            case 'silver':
                ...
                $responseText = "💎 عالیه! تو برنده *{$wonSilver} نقره* شدی! 💎\n\n" .
                                "💡 *کاربرد نقره:* از منوی اصلی وارد بخش «$brand_plus ➕» شو و نقره‌هات رو به سکه تبدیل کن.\n\n" .
...
👈 آیدی عددی شما : '."`$from_id`", $message_id, json_encode([
   ...
   elseif($message == $brand_plus . " ➕"){
    sm($from_id,
        "🍫 *به $brand_plus خوش آمدید!* ⚡️\n\n".
...
👍 در جریان باش که سکه هات باید از 3 تا 5000 سکه باشه!
...
👇 جهت ادامه پرداخت روی دکمه زیر بزنید :",$message_id,json_encode(['inline_keyboard'=>[
            ...
            sm($from_id,"🪓  تعداد وارده باید از 3 تا 5000 سکه باشد!
➕ تعداد وارده شما : $message
